...
def PlotErrors(errors, logInd):
    ...
    ax[0, 0].set_ylabel('log10(train/test error)')
    ax[0, 1].scatter(np.arange(numErrs), errors[:, 2], c='r')
    ax[0, 1].scatter(np.arange(numErrs), errors[:, 3], c='b')
    ax[0, 1].set_ylabel('log10(reg. train/test error)')
    ax[0, 2].scatter(np.arange(numErrs), errors[:, 4], c='r')
    ax[0, 2].scatter(np.arange(numErrs), errors[:, 5], c='b')
    ax[0, 2].set_ylabel('log10(train/test loss1: autoencoder)')

    ax[1, 0].scatter(np.arange(numErrs), errors[:, 6], c='r')
    ax[1, 0].scatter(np.arange(numErrs), errors[:, 7], c='b')
    ax[1, 0].set_ylabel('log10(train/test loss2: dynamics)')
    ax[1, 1].scatter(np.arange(numErrs), errors[:, 8], c='r')
    ax[1, 1].scatter(np.arange(numErrs), errors[:, 9], c='b')
    ax[1, 1].set_ylabel('log10(train/test loss3: K linear)')

    ax[2, 0].scatter(np.arange(numErrs), errors[:, 10], c='r')
    ax[2, 0].scatter(np.arange(numErrs), errors[:, 11], c='b')
    ax[2, 0].set_ylabel('log10(train/test L_inf)')
    ax[2, 1].scatter(np.arange(numErrs), errors[:, 12], c='r')
    ax[2, 1].scatter(np.arange(numErrs), errors[:, 13], c='b')
    ax[2, 1].set_ylabel('log10(train/test L1)')
    ax[2, 2].scatter(np.arange(numErrs), errors[:, 14], c='r')
    ax[2, 2].scatter(np.arange(numErrs), errors[:, 15], c='b')
    ax[2, 2].set_ylabel('log10(train/test L2)')
    plt.tight_layout()
